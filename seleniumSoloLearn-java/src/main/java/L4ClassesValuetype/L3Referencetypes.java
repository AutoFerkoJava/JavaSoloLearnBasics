 ...
 */
/*
 * public class L3Referencetypes {
 * 
 * public static void main(String[] args) { Person j; j = new Person("John");
 * j.setAge(20); celebrateBirthday(j); System.out.println(j.getAge()); }
 * 
