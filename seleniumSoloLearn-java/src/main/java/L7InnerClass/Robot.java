...
Once you declare an inner class private, it cannot be 
...
/*
 ...
 The inner class can access all of the member variables 
 and methods of its outer class, but it cannot be accessed 
